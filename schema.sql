...
insert into objetivos (institucion_id, creado_por, nombre, icono, descripcion, responsable_texto, meta, cumplimiento, estado, tendencia, fecha_inicio, fecha_cierre) values
  ('00000000-0000-0000-0000-000000000001', null, 'Uso del celular en clases', '📵', 'Implementar y sostener la política de no uso de celulares durante horas de clase.', 'Coordinador de convivencia', '0 incidentes semanales', 55, 'warn', 'bajando', '2025-03-01', '2025-07-31'),
  ('00000000-0000-0000-0000-000000000001', null, 'Cumplimiento del uniforme', '👕', 'Garantizar el uso correcto del uniforme escolar como parte de la identidad institucional.', 'Equipo de preceptores', 'Menos del 5% de incumplimiento diario', 82, 'ok', 'estable', '2025-03-01', '2025-11-30'),
  ('00000000-0000-0000-0000-000000000001', null, 'Puntualidad al ingreso', '⏰', 'Reducir las tardanzas al inicio de la jornada escolar.', 'Directivo + preceptores', 'Menos del 5% de tardanzas mensuales', 28, 'risk', 'subiendo', '2025-04-01', '2025-07-31'),
  ('00000000-0000-0000-0000-000000000001', null, 'Cuidado de espacios comunes', '🧹', 'Fomentar el respeto y cuidado del edificio, patios y baños.', 'Preceptores + guardia', 'Cero incidentes de deterioro intencional por semana', 90, 'ok', 'bajando', '2025-03-01', '2025-11-30');